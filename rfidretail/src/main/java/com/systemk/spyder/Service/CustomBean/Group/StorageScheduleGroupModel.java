package com.systemk.spyder.Service.CustomBean.Group;

public class StorageScheduleGroupModel {
	...
	public void setTotalStyleCount(Long totalStyleCount) {
	...
	public void setTotalTagCount(Long totalTagCount) {
