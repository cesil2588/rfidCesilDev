...
@Component
public class ProductJobCompletionNotificationListener extends JobExecutionListenerSupport {
	...
	@Autowired
	public ProductJobCompletionNotificationListener(JdbcTemplate template) {
