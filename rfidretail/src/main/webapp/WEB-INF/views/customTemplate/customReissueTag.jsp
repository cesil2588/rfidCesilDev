...
<html ng-app="myApp">
	<div class="modal-header">
		<h3 class="modal-title" id="modal-title">태그 재발행 요청</h3>
	</div>
	<div class="modal-body" id="modal-body">
		<div class="form-row">
			<div class="form-group col-2">
				발행장소 선택 :
				&nbsp;&nbsp;
				<select class="custom-select" ng-model="search.publishLocation">
					<option value="1">발행업체</option>
					<option value="2">물류센터</option>
				</select>
			</div>
		</div>
		<div class="form-row">
