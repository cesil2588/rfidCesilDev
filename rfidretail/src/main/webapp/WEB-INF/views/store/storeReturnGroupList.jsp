...
<div class="fade show starter-template" ng-show="authenticated && ajaxFinish" id="test">
	<div class="container-fluid">
		<div class="body-contents" ng-class="sidebarFlag ? 'sidebar-true' : 'sidebar-false'">
			<h2><a href="" ng-click="reload()">반품 요청 작업 목록</a></h2>
			...
			<div class="pull-right">
				<button ng-click="deleteGroup()" class="btn btn-danger">삭제</button>
				<button ng-click="confirmGroup()" class="btn btn-primary">확정</button>
			</div>
		</div>
	</div>
</div>
