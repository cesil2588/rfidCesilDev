...
<html ng-app="myApp">
	<div class="modal-header">
		<h3 class="modal-title" id="modal-title">반품 박스 상세</h3>
	</div>
							...
							<table class="table table-striped table-bordered table-hover text-center custom-align-middle">
								...
								<tbody>
									<tr>
										...
										<td>
											<span ng-if="data.confirmYn == 'N' && data.completeYn == 'N'">반품 예정</span>
											<span ng-if="data.confirmYn == 'Y' && data.completeYn == 'N'">반품 확인</span>
											<span ng-if="data.confirmYn == 'Y' && data.completeYn == 'Y'">반품 완료</span>
										</td>
