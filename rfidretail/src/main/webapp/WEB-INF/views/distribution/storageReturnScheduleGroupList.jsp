...
<div class="fade show starter-template" ng-show="authenticated && ajaxFinish" id="test">
	<div class="container-fluid">
		<div class="body-contents" ng-class="sidebarFlag ? 'sidebar-true' : 'sidebar-false'">
			<h2><a href="" ng-click="reload()">반품 입고예정 작업 목록</a></h2>
			<div class="card card-body" style="margin-bottom:5px;"> 
				<div class="form-row">
					<div class="form-group form-inline">
						...
						매장명 : 
						&nbsp;&nbsp;
						<input type="text" ng-model="search.companyInfo" placeholder="매장명 입력" uib-typeahead="company as company.name for company in companyList | filter:{name:$viewValue, type:'5'} && filter:{name:$viewValue, type:'6'}" class="form-control" typeahead-show-hint="true" typeahead-min-length="0">
					</div>
				</div>
				<div class="form-row">
					<div class="form-inline">
	          			<button ng-click="headSearch()" class="btn btn-primary">&nbsp;&nbsp;조회&nbsp;&nbsp;</button>&nbsp;&nbsp;&nbsp;&nbsp;
	          			<button ng-click="completeReturnBoxInfoExcelDownload()" class="btn btn-primary" style="float: right;"><i class="xi-download" aria-hidden="true"></i>당월 반품 내역 엑셀 다운로드</button>
	          		</div>
	          	</div>
          	</div>
			...
			<table class="table table-striped table-bordered table-hover text-center custom-align-middle" ng-if="list.length > 0">
				<thead>
					<tr class="pointer">
						<th width="11.1%">반품 예정 박스</th>
						<th width="11.1%">반품 완료 박스</th>
						<th width="11.1%">총 박스 수량</th>
						<th width="11.1%">반품 예정 스타일</th>
						<th width="11.1%">반품 완료 스타일</th>
						<th width="11.1%">총 스타일</th>
						<th width="11.1%">반품 예정 태그</th>
						<th width="11.1%">반품 완료 태그</th>
			...
			<table class="table table-striped table-bordered text-center custom-align-middle">
				<thead>
					<tr class="pointer">
						...
						<th ng-click="sort('arrivalDate')" rowspan="2">미결 발생일</th>
			...
			<!-- <div class="pull-right">
				<button ng-click="storageReturn()" class="btn btn-primary">반품 입고 반송</button>
				<button ng-click="storageComplete()" class="btn btn-primary" ng-if="testMode">반품 입고 완료</button>
			</div> -->
		</div>
	</div>
</div>
