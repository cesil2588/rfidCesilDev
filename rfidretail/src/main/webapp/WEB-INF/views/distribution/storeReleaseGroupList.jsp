...
<div class="fade show starter-template" ng-show="authenticated && ajaxFinish" id="test">
	<div class="container-fluid">
		...
		<h2><a href="" ng-click="reload()">매장 출고작업 목록</a></h2>
			<div class="card card-body" style="margin-bottom:5px;"> 
				<div class="form-row">
					<div class="form-group form-inline">
						...
						도착지 : 
						&nbsp;&nbsp;
						<input type="text" ng-model="search.companyInfo" placeholder="도착지명 입력" uib-typeahead="company as company.name for company in companyList | filter:{name:$viewValue}" class="form-control" typeahead-show-hint="true" typeahead-min-length="0">
					</div>
				</div>
				<div class="form-row">
			...
			<table class="table table-striped table-bordered text-center custom-align-middle">
				<thead>
					<tr class="pointer">
						...
						<th ng-click="sort('createDate')" rowspan="2">작업 일자</th>
						<th ng-click="sort('name')" rowspan="2">도착 업체명</th>
						<th rowspan="2">구분</th>
						<th colspan="3">수량</th>
						<th rowspan="2">진척율</th>
					</tr>
			...
			<div class="pull-right">
				<button ng-click="confirmDel()" class="btn btn-lg btn-danger">삭제</button>
				<button ng-click="confirmComplete()" class="btn btn-lg btn-primary">출고 확정</button>
			</div>
			-->
		</div>
	</div>
