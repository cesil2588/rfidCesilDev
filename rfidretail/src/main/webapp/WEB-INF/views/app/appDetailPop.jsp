...
<html ng-app="myApp">
	<div class="modal-header">
		<h3 class="modal-title" id="modal-title">어플리케이션 상세</h3>
	</div>
					...
					<div class="row">
						...
						<div class="form-group col-3">
						    ...
						    <div class="custom-control custom-radio custom-control-inline">
								<input name="inputType" id="inputType1" type="radio" ng-model="data.type" value="1" class="custom-control-input">
								<label class="custom-control-label" for="inputType1">생산</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input name="inputType" id="inputType2" type="radio" ng-model="data.type" value="2" class="custom-control-input">
								<label class="custom-control-label" for="inputType2">물류</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input name="inputType" id="inputType3" type="radio" ng-model="data.type" value="3" class="custom-control-input">
								<label class="custom-control-label" for="inputType3">매장</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline">
								<input name="inputType" id="inputType4" type="radio" ng-model="data.type" value="4" class="custom-control-input">
	...
	<div class="modal-footer">
		...
		<button type="button" ng-click="mod()" class="btn btn-primary">수정 완료</button>
    </div>
</html>