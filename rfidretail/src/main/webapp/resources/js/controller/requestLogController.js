app.controller('requestLogListController', ['$scope', '$http', '$location', '$rootScope', '$window', '$uibModal', function ($scope, $http, $location, $rootScope, $window, $uibModal) {
	
	$scope.ajaxFinish = false;
	
	$scope.search = initSearch("jobName", "requestLogSeq", "desc", angular.fromJson($window.sessionStorage.getItem("current")));
	...
	httpGetList("/requestLog", param, $scope, $http, true);
	...
	$scope.goPage = function(page){
		...
		httpGetList("/requestLog", param, $scope, $http);
...
//		
//		$location.url("/requestLog/requestLogDetail?seq=" + obj.requestLogSeq);
		
		var modalInstance = $uibModal.open({
	    	animation: true,
	    	ariaLabelledBy: 'modal-title',
	    	ariaDescribedBy: 'modal-body',
	    	templateUrl: '/requestLog/requestLogDetailPop',
	    	controller: 'requestLogDetailPopController',
	    	size: 'xlg',
	    	resolve: {
	    		obj: function () {
	    			return obj;
...
app.controller('requestLogDetailPopController', ['$scope', '$http', '$location', '$rootScope', '$interval', '$routeParams', 'verificationFactory', '$filter', '$uibModalInstance', 'obj', '$uibModal', 
